...
class FCI_Bot:
    ...
    def _getDataC_(self, url):
        ...
        posStart = datos_crudos.find("Cablevision Holding CL. B")
        CVH = datos_crudos[posStart+160:]
        ...
        try:
            ...
            print("Error conversion a float getCVH")
            CVH = -1
    ...
    def _loadParameters_(self, url):
        ...
        posStart = datos_crudos.find(
            """<p class="encuentreColortxt ng-binding">1822 Raices Valores Negociables<br/>Composición de Cartera al """)
        tamañoStart = len(
            """<p class="encuentreColortxt ng-binding">1822 Raices Valores Negociables<br/>Composición de Cartera al""")
        posEnd = datos_crudos.find(
            """ </p>, <p class="destacado ng-binding">ARS 1000</p>, <p class="destacado ng-binding">48 hs. hábiles</p>""")
        ...
        while True:
            ...
            try:
                ...
                self.time = float(
                    input("Ingrese la velocidad de funcionamiento, recomendable 8.0 (sg.ms): "))
                break
            except:
    ...
    def _writeExcel_(self):
        ...
        if self.choice == 1:
            ...
            outWorkbook = xlsxwriter.Workbook("outCVH.xlsx")
            outSheet = outWorkbook.add_worksheet()
